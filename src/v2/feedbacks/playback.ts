...
export function createPlaybackFeedbackss(ontime: OntimeV2): { [id: string]: CompanionFeedbackDefinition } {
	...
	return {
		[feedbackId.ColorPlayback]: {
			...
			callback: (feedback) => ontime.state.playback === feedback.options.state,
		},
