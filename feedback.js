...
exports.getFeedbacks = function () {
    ...
    options: [
      {
        ...
        id: 'run_fg',
        default: splitRgb(255, 255, 255),
      },
      {
        type: 'colorpicker',
        name: 'Running: Background color',
        id: 'run_bg',
        default: splitRgb(0, 204, 0),
      },
      {
        type: 'colorpicker',
  ...
  feedbacks['timer_negative'] = {
    ...
    defaultStyle: {
      color: splitRgb(255, 255, 255),
      bgcolor: splitRgb(255, 0, 0),
    },
    callback: (feedback) => {
